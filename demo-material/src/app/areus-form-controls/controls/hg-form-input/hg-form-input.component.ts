...
@Component({
  selector: 'hg-form-input',
  templateUrl: './hg-form-input.component.html',
  styleUrls: ['./hg-form-input.component.scss']
})
export class HgFormInputComponent implements ControlValueAccessor, OnInit {
